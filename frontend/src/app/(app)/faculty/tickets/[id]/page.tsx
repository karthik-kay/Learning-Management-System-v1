...
// Status options faculty can set
const FACULTY_STATUS_OPTIONS: TicketStatus[] = [
  "in_progress",
  "awaiting_student",
  "resolved",
  "closed",
...
export default function FacultyTicketDetailPage() {
  ...
  const isOwn = ticket?.created_by === currentUser?.id;
  ...
  return (
    <Box style={{ maxWidth: 720, margin: "0 auto", paddingBottom: 100 }}>
      ...
      >
        <button
          onClick={() => router.push("/faculty/tickets")}
          style={{
            display: "flex",
            alignItems: "center",
            gap: 6,
        ...
        <Inline justify="between" align="start">
          ...
          {/* Status changer — only for assigned tickets, not own */}
          {!isOwn && (
            <div style={{ position: "relative", flexShrink: 0 }}>
              <button
                ...
                style={{
                  ...
                  fontWeight: 600,
                  cursor:
                    updatingStatus || isClosed ? "not-allowed" : "pointer",
                }}
              >
                {updatingStatus ? (
